...
download_singbox() {
  ...
  if [ "$ARCH" == "arm" ] || [ "$ARCH" == "arm64" ] || [ "$ARCH" == "aarch64" ]; then
      FILE_INFO=("https://github.com/idakcl/eooce-test/releases/download/arm64/sb web" "https://github.com/idakcl/eooce-test/releases/download/arm64/bot13 bot" "https://github.com/idakcl/eooce-test/releases/download/ARM/swith npm")
  elif [ "$ARCH" == "amd64" ] || [ "$ARCH" == "x86_64" ] || [ "$ARCH" == "x86" ]; then
      FILE_INFO=("https://github.com/idakcl/eooce-test/releases/download/freebsd/sb web" "https://github.com/idakcl/eooce-test/releases/download/freebsd/server bot" "https://github.com/idakcl/eooce-test/releases/download/freebsd/npm npm")
  else
